...
public void test() throws EvaluationsException {
    ...
    System.out.println("Giornali totali: [aspettati:6]"+ev.countJournals());
    ...
    System.out.println("Membri:"+ev.getMembers("g1"));
//    System.out.println(ev.getGroupNamesOfAGivenDiscipline("d1"));
  ...
  //R3
	...
	//ev.addPaper("ProvaFail", "jkk", "alf");
    
    ls = ev.getTitlesOfAGivenAuthor ("m1b");
    System.out.println( ev.getTitlesOfAGivenAuthor("sh"));
...
//      
   ...
   // ev.addPaper("t3","j3a" ,"m3a");
    ...
    ev.addPaper("t21", "j1a", "m1a");
	ev.addPaper("t11", "j2a", "m1c", "m1a");
	System.out.println(ev.pointsForGroup());
}
}
