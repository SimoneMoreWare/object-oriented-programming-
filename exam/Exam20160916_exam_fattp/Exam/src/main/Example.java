...
public class Example {
	...
	public static void main(String[] args) throws ExamException{
		...
		System.out.println(numberOfStudentsForStudyPlan); //{cs1=2, cs2=2}
		SortedMap<String, List<String>> studentsForStudyPlan = eh.studentsForStudyPlan();
		System.out.println(studentsForStudyPlan); //{cs1=[jo, my], cs2=[an, fk]}
		...
		System.out.println (eh.gradesOfStudent("jo")); //{30=[data structures], 27=[oop, operating systems]}
		
		System.out.println (eh.gradesOfCourse("oop")); //{29=[fk, my], 27=[jo]}
		eh.giveGrade("operating systems", "my", 15);	
		System.out.println (eh.failingGradesOfStudent("my")); //1
		System.out.println (eh.failingGradesOfCourse("operating systems")); //1
